...
def test_v084_metadata_and_public_client_contract() -> None:
    ...
    assert payload["server"] == {"version": "0.12.6", "build": "local-mobile"}
...
def test_api_responses_expose_client_compatibility_headers() -> None:
    ...
    assert response.headers["X-VerbaNode-Version"] == "0.12.6"
...
def test_dashboard_is_split_into_ordered_client_modules() -> None:
    ...
    tags = [
        '/static/js/runtime.js?v=0.12.6',
        '/static/js/client.js?v=0.12.6',
        '/static/js/browser-ptt.js?v=0.12.6',
        '/static/js/diagnostics.js?v=0.12.6',
        '/static/app.js?v=0.12.6',
    ]
    positions = [index.index(tag) for tag in tags]
    assert positions == sorted(positions)

    assert "const FRONTEND_VERSION = '0.12.6'" in runtime

...
def test_v077_hardening_layout_and_ci_are_present() -> None:
    ...
    assert '/static/VerbaNode.png?v=0.12.4' in index_html
    assert 'styles.css?v=0.12.4' in index_html
    assert 'app.js?v=0.12.4' in index_html
    assert 'id="appVersion">v0.12.4<' in index_html

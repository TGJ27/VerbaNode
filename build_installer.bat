...
echo ============================================================
echo VerbaNode v0.7.6 online Windows installer build
echo ============================================================
echo.

if not exist "dist\VerbaNode\VerbaNode.exe" (
  echo ERROR: dist\VerbaNode\VerbaNode.exe was not found.
  echo Run build_windows.bat first. The v0.7.6 app build contains the
...
echo ============================================================
echo Output:
echo   %CD%\dist-installer\VerbaNode-Setup-0.7.6.exe
echo.
